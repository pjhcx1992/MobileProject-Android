...
public class YinShangDian extends DataSupport {
    private String ysdname;
    private String ziyuanstate;
    ...
    public String getYsdname() {
        return ysdname;
    }

    public void setYsdname(String ysdname) {
        this.ysdname = ysdname;
    }

    public String getZiyuanstate() {
        return ziyuanstate;
    }

    public void setZiyuanstate(String ziyuanstate) {
        this.ziyuanstate = ziyuanstate;
    }
